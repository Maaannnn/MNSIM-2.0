...
Recommended replacement:
  python run_dse.py --algos mobo --seeds 42 --budget 20 ...
"""
import warnings
warnings.warn(
    "dse_mobo_parego.py is deprecated. Use: python run_dse.py --algos mobo",
    DeprecationWarning,
    stacklevel=2,
)
...
def main() -> None:
    cwd = os.getcwd()
    parser = argparse.ArgumentParser(description="[DEPRECATED] MOBO ParEGO DSE — use run_dse.py instead")
