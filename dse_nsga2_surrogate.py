...
Recommended replacement:
  python run_dse.py --algos nsga2 --seeds 42 --budget 24 ...
"""
import warnings
warnings.warn(
    "dse_nsga2_surrogate.py is deprecated. Use: python run_dse.py --algos nsga2",
    DeprecationWarning,
    stacklevel=2,
)
...
def main() -> None:
    cwd = os.getcwd()
    parser = argparse.ArgumentParser(description="[DEPRECATED] NSGA-II DSE — use run_dse.py instead")
